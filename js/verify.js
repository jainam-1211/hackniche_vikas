window.CONTRACT = {
  address: '0xFd37De1A5a98cBa001BB140f1E6466BE242971BF',
...
function verify12(){
	document.getElementById('verify').innerHTML = "Verification Successful"
	// alert("Verification success")
}


function verify13(){
	document.getElementById('verify').innerHTML = "Verification Failed"
	// alert("Verification success")
}
